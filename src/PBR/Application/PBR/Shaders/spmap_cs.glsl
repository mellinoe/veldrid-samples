...
layout(set=0, binding=0, rgba16f) restrict writeonly uniform image2DArray outputTexture[NumMipLevels];
...
vec2 texSize(textureCube tex, int lod) {
...
void main(void)
{
	...
	vec2 inputSize = vec2(texSize(inputTexture, 0));
